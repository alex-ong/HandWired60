...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        ...
        TRNS,  FN8,   UP, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, HOME,  INS, TRNS, \
        TRNS, LEFT, DOWN, RGHT, TRNS, TRNS, PSCR, SLCK, PAUS, TRNS, TRNS,  END,       TRNS, \
        TRNS,  DEL, TRNS, TRNS, MUTE, VOLU, VOLD, TRNS, PGUP, PGDN,  DEL,             TRNS, \
        TRNS, TRNS, TRNS,              FN7,                         TRNS, TRNS, TRNS, TRNS  ),
    /* layer 4 */
    KEYMAP(
        TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, \
        TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, \
